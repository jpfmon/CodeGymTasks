...
4. The isModifierSet method must return the correct value according to the task conditions
(true, if the specified modifier is set in allModifiers; otherwise, false).
*/
public class Solution {
    public static void main(String[] args) {
        ...
        //System.out.println(Modifier.STATIC + " | " +Modifier.PUBLIC + " | " + methodModifiers);
