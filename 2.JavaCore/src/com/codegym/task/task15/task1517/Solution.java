...
This will stop the class from loading,
and you will see the following error message instead of the value of the variable B
...
2. The program should not display anything (except an automatic
message about the exception that occurs).
