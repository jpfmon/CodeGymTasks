...
Implement the getNumbers method. Among numbers less than N (long),
...
Requirements:
1. The Solution class must have a getNumbers method with one long parameter.
2. The getNumbers method must be public.
3. The getNumbers method must be static.
4. The getNumbers method must return the array of numbers that satisfy the task conditions.
*/
