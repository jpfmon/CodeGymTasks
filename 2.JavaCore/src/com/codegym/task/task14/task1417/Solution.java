...
4. In the Euro, Ruble, and USD classes, implement the getCurrencyName method, which will return the abbreviated nameof the currency (String)
(EUR, RUB, USD).
...
2. The Money class must implement a public constructor with one double parameter, which sets the variable amount to the passed parameter.
...
This constructor must set the value of the Money class's field amount by calling the parent class's constructor with the same argument.
*/
